...
export function Titlemkr({ showtext, tsize, color1, fontT }) {
  ...
  return (
    ...
    <div className="Titulo">
      <div className={fontT}>
        <div className={tsize}>
          <div className={color1}>{showtext}</div>
        </div>
      </div>
    </div>
  );
    ...
    <div className="imageplaces">
      <div className={hlength}>
        <div className={Wlength}>
          <img src={imglink} alt="imagen demo" />
        </div>
      </div>
    </div>
  );
  ...
  if (contadorbool == true) {
    return (
      <div>
        ...
        <Imagesmkr
          imglink="https://tse2.mm.bing.net/th/id/OIP.7WSlC4MOx7NduqGdM02HbAHaEK?rs=1&pid=ImgDetMain&o=7&rm=3"
          hlength="h-100"
          Wlength="w-50"
        ></Imagesmkr>
      </div>
    ...
    return (
      <div>
        ...
        <Imagesmkr
          imglink="https://tse3.mm.bing.net/th/id/OIP.kGxLj1iwzcdRFES08HChMgHaJ4?rs=1&pid=ImgDetMain&o=7&rm=3"
          hlength="h-50"
          Wlength="w-50"
        ></Imagesmkr>
      </div>
...
export default function Home() {
  return (
    <main>
      <div>
        <Titlemkr
          showtext=" ¡ Los BIONICLES son geniales !"
          tsize="text-[70px]"
          color1="text-[#7e561a]"
          fontT="font-bold"
        />
        ...
        <Paragraphmkr
          ptext="Mi bionicle favorito es Vakama, este no es vakama, pero se ve genial y me funciono la imagen"
          colorp="color-[#b259b8]"
          sizep="text-[20px]"
          fontp="font-sans"
        />
        ...
        <Imagesmkr
          imglink="https://tse1.mm.bing.net/th/id/OIP.KcFmFpk8jxRWVyKWgOkNPQHaHi?rs=1&pid=ImgDetMain&o=7&rm=3 "
          hlength="h-50"
          Wlength="w-50"
        />
